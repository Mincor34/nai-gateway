...
(Imported from `caru-ini/novelai-sdk` - August 28, 2026 - [29daea9])

[GuildWeave comments in brackets]
...
not change the base price [except for `bg-removal`]). The formula is:
...
upscale yet. [Consider implementing this for GuildWeave.]
